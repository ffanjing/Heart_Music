...
public class Constant {
    ...
    public static final String NO_USERINFO = "NO_USERINFO";
    public static final String USER_NULL = "USER_NULL";
    public static final String DATABASE_ERR = "DATABASE_ERR";
    public static final String MYSQL_URL = "jdbc:mysql://120.55.98.138:3306/heart_music";
    public static final String MYSQL_USERNAME = "zdhdqkz";
    public static final String MYSQL_PASSWORD = "zdhdqkz";
